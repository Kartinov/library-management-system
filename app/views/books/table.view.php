                    ...
                    <tbody>
                        <?php foreach ($data['books'] as $book) : ?>
                            <tr>
                                ...
                                <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm">
                                    <a href="<?= route("books/create/{$book->id}") ?>" class="flex items-center px-2 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
