        ...
        <div class="flex justify-between items-center px-4 py-5 sm:px-6">
            <div>
                <h3 class="text-lg leading-6 font-medium text-gray-900">
                    Authors management</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Here you can add, delete and edit authors.</p>
            </div>
            ...
            <div>
                <a href="<?= route("authors/create") ?>" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 cursor-pointer">
                    Add new author
                </a>
            </div>
        </div>
                    ...
                    <table class="leading-normal mx-auto mt-5 shadow">
                        ...
                        <tbody>
                            <?php foreach ($data['authors'] as $author) : ?>
                                ...
                                <?php if (!(bool) $author->is_archived) : ?>
                                    <tr>
                                        ...
                                        <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm flex gap-4">
                                            ...
                                            <!-- Edit button -->
                                            <a href="<?= route("authors/create/{$author->id}") ?>" class="flex items-center px-2 py-2 w-24 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                                            ...
                                            <!-- Delete button -->
                                            <a href="<?= route("authors/archieve/{$author->id}") ?>" class="flex items-center px-2 py-2 font-medium tracking-wide w-24 text-white capitalize transition-colors duration-200 transform bg-red-600 rounded-md hover:bg-red-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                                ...
                                <?php if ((bool) $author->is_archived) : ?>
                                    <tr>
                                        ...
                                        <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm flex gap-4">
                                            ...
                                            <!-- Delete button -->
                                            <a href="<?= route("authors/restore/{$author->id}") ?>" class="flex items-center px-2 py-2 font-medium tracking-wide w-24 text-white capitalize transition-colors duration-200 transform bg-green-600 rounded-md hover:bg-green-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
