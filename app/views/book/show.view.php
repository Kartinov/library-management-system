...
<div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="flex flex-wrap sm:flex-no-wrap w-full max-w-4xl mx-auto py-5">
        ...
        <div class="w-full sm:w-1/2 sm:p-5 prose">
            <h2 class="font-semibold text-3xl lg:text-4xl lg:leading-9 leading-7 text-gray-800 mt-4"><?= $data['book']->title ?></h2>
