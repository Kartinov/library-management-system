...
<div class="max-w-7xl mx-auto py-5 flex flex-wrap sm:flex-no-wrap items-center justify-between w-full sm:px-6"">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="flex flex-col sm:flex-row justify-center sm:justify-between items-center px-4 py-5 sm:px-6">
            ...
            <div>
                <a href="<?= route("categories/create") ?>" class="ml-8 inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 cursor-pointer">
                    Add new category
                </a>
            </div>
        </div>
        <div class="border-t border-gray-200">
            <div class="flex flex-wrap md:flex-nowrap w-full">
                <div class="w-full md:w-1/2 overflow-x-auto">
                    <table class="table-auto leading-normal mx-auto mt-5 shadow-lg">
                                ...
                                <?php if (!(bool) $category->is_archived) : ?>
                                    <tr>
                                        ...
                                        <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm flex gap-4">
                                            ...
                                            <!-- Edit button -->
                                            <a href="<?= route("categories/create/{$category->id}") ?>" class="flex items-center px-2 py-2 w-24 font-medium tracking-wide text-white capitalize transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-500">
                                            ...
                                            <!-- Delete button -->
                                            <a href="<?= route("categories/archieve/{$category->id}") ?>" class="flex items-center px-2 py-2 font-medium tracking-wide w-24 text-white capitalize transition-colors duration-200 transform bg-red-600 rounded-md hover:bg-red-500">
                                ...
                                <?php if ((bool) $category->is_archived) : ?>
                                    <tr>
                                        ...
                                        <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm flex gap-4">
                                            ...
                                            <!-- Delete button -->
                                            <a href="<?= route("categories/restore/{$category->id}") ?>" class="flex items-center px-2 py-2 font-medium tracking-wide w-24 text-white capitalize transition-colors duration-200 transform bg-green-600 rounded-md hover:bg-green-500">
